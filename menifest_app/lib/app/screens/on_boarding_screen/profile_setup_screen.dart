...
class _ProfileSetupScreenState extends State<ProfileSetupScreen>
  ...
  void initState() {
    ...
    if (provider.personalAnswers[0].trim().isEmpty && provider.name.isNotEmpty) {
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(color: AppColors.borderFaded, width: 1.w),
                            ),
                            child: Text(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                ...
                                gradient: i <= provider.onboardingStep
                                    ...
                                    : null,
                                color: i > provider.onboardingStep ? AppColors.stepDotInactive : null,
                              ),
                            ),
                          );
                        }),
                          ...
                          child: Center(
                            child: provider.isLoading
                                ...
                                : Text(
                                    ...
                                    style: AppTextStyles.buttonLarge.copyWith(fontSize: 16.sp),
                                  ),
                          ),
                        ),
                      ),
  ...
  List<_PageData> get _pages => const [
    _PageData(
      ...
      title: 'Tell Us\nAbout Yourself',
      questions: [
        _Question('What is your first name?', Icons.badge_outlined, 'e.g. Alex', false),
        _Question('How old are you?', Icons.cake_outlined, 'e.g. 25', false),
        _Question('Where are you from?', Icons.location_on_outlined, 'e.g. Mumbai, India', false),
        _Question(
    ...
    _PageData(
      ...
      questions: [
        ...
        _Question('Do you have children?', Icons.child_care_outlined, 'e.g. Yes, 2 kids', false),
        _Question(
    ...
    _PageData(
      ...
      title: 'Your Career\n& Ambitions',
      questions: [
        _Question('What do you do for work?', Icons.business_center_outlined, 'e.g. Software Engineer', false),
        _Question(
  ...
  Widget build(BuildContext context) {
    return Consumer<UserProvider>(
      builder: (context, provider, _) {
        ...
        final bool isError = provider.showOnboardingErrors && widget.value.trim().isEmpty;
