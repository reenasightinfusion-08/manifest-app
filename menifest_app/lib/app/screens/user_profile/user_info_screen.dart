...
class _UserInfoScreenState extends State<UserInfoScreen>
  ...
  void initState() {
    ...
    _nameController.text = provider.name == 'Alex Manifestor' ? '' : provider.name;
  ...
  Future<void> _createAccount(BuildContext context, UserProvider provider) async {
    ...
    if (!nameOk || !emailOk || !passwordOk) {
      ...
      _showError('The universe needs your name, email, and a 6+ character password ✨');
      return;
    }
  ...
  Widget build(BuildContext context) {
    return Consumer<UserProvider>(
      builder: (context, provider, _) {
        final bool emailError = _showErrors &&
            (!(_emailController.text.contains('@') &&
                    _emailController.text.contains('.')) ||
                provider.emailCheckError != null);
        final bool passwordError =
            _showErrors && _passwordController.text.length < 6;
        final bool nameError = _showErrors && _nameController.text.trim().isEmpty;
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextField(
                                  ...
                                  onChanged: (_) {
                                    if (context.read<UserProvider>().emailCheckError != null) {
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          child: Center(
                            child: (provider.isLoading || provider.checkingEmail)
                                ? SizedBox(
                                    width: 24.w,
                                    height: 24.w,
